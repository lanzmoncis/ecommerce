...
export const Hero = () => {
  return (
    <header className="bg-black-light relative flex flex-col h-[600px] mb-24 md:h-[768px]">
      <div className="bg-[url('/images/home/mobile/image-header.jpg')] bg-cover bg-center bg-no-repeat w-full h-full absolute md:bg-[url('/images/home/tablet/image-header.jpg')]"></div>
      ...
      <div className="relative flex justify-center items-center grow">
        <div className="flex flex-col justify-between items-center h-[290px] max-w-[329px] md:h-[346px] md:max-w-[379px]">
